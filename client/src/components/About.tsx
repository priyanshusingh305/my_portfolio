        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              <Image src="/About.png" alt="About Priyanshu Singh" fill className="object-contain object-center rounded-lg shadow-lg" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-base leading-relaxed">
                I am a Computer Science graduate from Dr. A.P.J. Abdul Kalam Technical University with expertise in full-stack development. Currently working at Pintude Solutions LLP, I design and deploy scalable microservices and build secure platforms with custom authentication systems.
              </p>
              
              <p className="text-base leading-relaxed">
                My technical skills include C++, JavaScript, Python, TypeScript, and frameworks like React, Express, NextJS, and Tailwind. I&#39;m experienced with databases including MongoDB, PostgreSQL, and MySQL, as well as tools like AWS, Docker, and Git.
              </p>
              
              <div className="mt-4 flex flex-wrap gap-3">
                <Link href="https://github.com/priyanshusingh305" target="_blank" className="text-sm bg-primary/10 hover:bg-primary/20 text-primary px-3 py-1 rounded-full transition-colors">GitHub</Link>
                <Link href="https://www.linkedin.com/in/akapriyanshudev" target="_blank" className="text-sm bg-primary/10 hover:bg-primary/20 text-primary px-3 py-1 rounded-full transition-colors">LinkedIn</Link>
