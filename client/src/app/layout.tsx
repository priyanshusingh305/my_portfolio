...
export const metadata: Metadata = {
	...
	openGraph: {
		title: "Priyanshu Singh | Full Stack Developer",
		description:
			"Portfolio website of Priyanshu Singh, a Full Stack Developer specializing in modern web technologies.",
		...
		<html lang="en" className="scroll-smooth">
			<body className={cn("min-h-screen bg-background font-sans antialiased", fontSans.variable)}>
				<ThemeProvider attribute="class" defaultTheme="dark" enableSystem disableTransitionOnChange>
					<Navbar />
					<div className="fixed md:top-4 md:right-4 z-10 bottom-4 right-4">{/* <ModeToggle /> */}</div>
