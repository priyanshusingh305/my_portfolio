                ...
                <div className="md:w-3/4 space-y-4">
                  ...
                  <div className="pt-2">
                    <p className="text-base leading-relaxed">
                      Completed my bachelor&#39;s degree with a focus on software development, data structures, algorithms,
                      and web technologies. Participated in various coding competitions and hackathons.
                    </p>
                  </div>
                </div>
              </div>
